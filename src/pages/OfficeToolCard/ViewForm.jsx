import { ArrayTable, DatePicker, Form, FormGrid, FormItem, FormLayout, Input, Select, TreeSelect,PreviewText } from '@formily/antd'
    ...
    <Form form={form} labelWidth={100} labelWrap={true} className={styles.placeholder}>
      <SchemaField>
        <SchemaField.Void x-component="FormGrid" x-component-props={{ maxColumns: 3, strictAutoFit: true }}>
          ...
          <SchemaField.String name="categoryName" title="设备类别" x-decorator="FormItem" x-component="PreviewText"/>
          ...
          <SchemaField.String name="haveOld" title="是否旧数据" x-decorator="FormItem" x-component="PreviewText"/>
