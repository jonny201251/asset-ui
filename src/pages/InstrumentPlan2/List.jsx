import { instrumentPlan2Path, proTableRequest } from '../../utils'
...
export default () => {
  ...
  const columns = [
    ...
    { title: '型号规格', dataIndex: 'modelSpec', valueType: 'text' },
    ...
    { title: '申请时间', dataIndex: 'level', valueType: 'text' },
    {
      ...
      render: (text, record, _, action) => [
        <OperateButton record={record} path={instrumentPlan2Path} actionRef={actionRef}/>,
      ],
    },
  ]
  ...
  return <ProTable
    ...
    //列表数据
    params={{ list: instrumentPlan2Path.list }}
    ...
    //
    headerTitle={
      <ToolBarButton path={instrumentPlan2Path} actionRef={actionRef} formRef={formRef}/>
    }
  />
}
