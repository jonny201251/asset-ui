...
const InputButton = (props) => {
  ...
  props.form.query('list.' + index + '.*(number,price)').forEach(field => field.setPattern('disabled'))
        ...
        >
          <SchemaField.Object>
            <SchemaField.Void x-component="ArrayTable.Column"
                              x-component-props={{ width: 250, title: '名称', align: 'center' }}>
              <SchemaField.String
            ...
            <SchemaField.Void x-component="ArrayTable.Column" x-component-props={{ title: '购置日期', align: 'center' }}>
              <SchemaField.String name="buyDate" required x-decorator="FormItem" x-component="DatePicker"/>
            </SchemaField.Void>
            ...
            <SchemaField.Void
              x-component="ArrayTable.Column" x-component-props={{ width: 200, title: '使用地点', align: 'center' }}>
              <SchemaField.String name="location" x-decorator="FormItem" x-component="Input"/>
            </SchemaField.Void>
            <SchemaField.Void x-component="ArrayTable.Column" x-component-props={{ title: '使用人', align: 'center' }}>
              <SchemaField.String name="useLoginName" required x-decorator="FormItem"
