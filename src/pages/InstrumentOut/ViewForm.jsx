...
export default (props) => {
  ...
  return <ConfigProvider locale={zhCN}>
    <Form form={form} labelWidth={110} labelWrap={true} className={styles.placeholder}>
      <SchemaField>
        <SchemaField.Void x-component="FormGrid" x-component-props={{ maxColumns: 3, strictAutoFit: true }}>
          ...
          <SchemaField.String name="b" title="至累计折旧" x-component="Input"
                              x-decorator="FormItem" x-decorator-props={{ tooltip: '基数累计折旧，截止至累计折旧(2020-12-31)' }}/>
