...
const InputButton = (props) => {
  ...
  props.form.query('list.' + index + '.*(categoryName,number,startMoney)').forEach(field => field.setPattern('disabled'))
      ...
      <SchemaField>
        ...
        >
          <SchemaField.Object>
            ...
            <SchemaField.Void x-component="ArrayTable.Column" x-component-props={{width: 200, title: '使用地点', align: 'center' }}>
