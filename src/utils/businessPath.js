...
import AssetLoseList from '../pages/AssetLose/List';
...
export const officeToolPlanPath = {
  flag: 'officeToolPlanPath',
  width: 1600,
  List: OfficeToolPlanList,
  AddForm: OfficeToolPlanAddForm,
  EditForm: OfficeToolPlanAddForm,
  CheckForm: OfficeToolPlanAddForm,
  ViewForm: OfficeToolPlanViewForm,
...
export const officeToolPlan2Path = {
  flag: 'officeToolPlan2Path',
  List: OfficeToolPlan2List,
  Form: OfficeToolPlan2Form,
  list: contextPath + '/officeToolPlan2/list',
  get: contextPath + '/officeToolPlan2/get',
};
export const instrumentPlanPath = {
  flag: 'instrumentPlanPath',
  width: 1600,
  List: InstrumentPlanList,
  AddForm: InstrumentPlanAddForm,
  EditForm: InstrumentPlanAddForm,
  CheckForm: InstrumentPlanAddForm,
  ViewForm: InstrumentPlanViewForm,
...
export const instrumentPlan2Path = {
  flag: 'instrumentPlan2Path',
  List: InstrumentPlan2List,
  Form: InstrumentPlan2Form,
...
export const assetBuy1Path = {
  ...
  width: 1600,
  List: AssetBuy1List,
  AddForm: AssetBuy1AddForm,
  EditForm: AssetBuy1AddForm,
  CheckForm: AssetBuy1AddForm,
  ViewForm: AssetBuy1ViewForm,
...
export const assetBuy2Path = {
  ...
  width: 1600,
  List: AssetBuy2List,
  AddForm: AssetBuy2AddForm,
  EditForm: AssetBuy2AddForm,
  CheckForm: AssetBuy2AddForm,
  ViewForm: AssetBuy2ViewForm,
...
export const taxInvoicePath = {
  ...
  Form: TaxInvoiceForm,
  List: TaxInvoiceList,
  EditForm: TaxInvoiceEditForm,
  ViewForm: TaxInvoiceEditForm,
...
export const instrumentInPath = {
  flag: 'instrumentInPath',
  width: '98%',
  width2: 1000,
  Form: InstrumentInForm,
  List: InstrumentInList,
  EditForm: InstrumentInEditForm,
  ViewForm: InstrumentInViewForm,
...
export const instrumentOutPath = {
  flag: 'instrumentOutPath',
  width: 1200,
  width2: 1000,
  Form: InstrumentOutForm,
  List: InstrumentOutList,
  EditForm: InstrumentOutEditForm,
  ViewForm: InstrumentOutViewForm,
...
export const instrumentCardPath = {
  flag: 'instrumentCardPath',
  width: 1000,
  width2: 1000,
  Form: InstrumentCardForm,
  List: InstrumentCardList,
  EditForm: InstrumentCardEditForm,
  ViewForm: InstrumentCardViewForm,
...
export const officeToolCardPath = {
  flag: 'officeToolCardPath',
  width: 1000,
  width2: 1000,
  Form: OfficeToolCardForm,
  List: OfficeToolCardList,
  EditForm: OfficeToolCardEditForm,
  ViewForm: OfficeToolCardViewForm,
...
export const houseCardPath = {
  ...
  Form: HouseCardForm,
  List: HouseCardList,
  EditForm: HouseCardEditForm,
  ViewForm: HouseCardViewForm,
...
export const assetRepairPath = {
  flag: 'assetRepairPath',
  width: 1600,
  List: AssetRepairList,
  AddForm: AssetRepairAddForm,
  EditForm: AssetRepairAddForm,
  CheckForm: AssetRepairAddForm,
  ViewForm: AssetRepairViewForm,
...
export const assetAcceptPath = {
  flag: 'assetAcceptPath',
  width: 1200,
  width2: 900,
  Form: AssetAcceptForm,
  List: AssetAcceptList,
  EditForm: AssetAcceptEditForm,
  ViewForm: AssetAcceptViewForm,
...
export const assetScrapPath = {
  ...
  width: 1600,
  List: AssetScrapList,
  AddForm: AssetScrapAddForm,
  EditForm: AssetScrapAddForm,
  CheckForm: AssetScrapAddForm,
  ViewForm: AssetScrapViewForm,
...
export const assetScrapValuePath = {
  flag: 'assetScrapValuePath',
  width: 1600,
  List: AssetScrapValueList,
  AddForm: AssetScrapValueAddForm,
  EditForm: AssetScrapValueAddForm,
  CheckForm: AssetScrapValueAddForm,
  ViewForm: AssetScrapValueViewForm,
...
export const assetScrapProject1Path = {
  flag: 'assetScrapProject1Path',
  width: 1000,
  width2: 1000,
  Form: AssetScrapProject1Form,
  List: AssetScrapProject1List,
  EditForm: AssetScrapProject1EditForm,
  ViewForm: AssetScrapProject1ViewForm,
...
export const assetTurnPath = {
  ...
  width: 850,
  List: AssetTurnList,
  AddForm: AssetTurnAddForm,
  EditForm: AssetTurnAddForm,
  CheckForm: AssetTurnAddForm,
  ViewForm: AssetTurnViewForm,
  list: contextPath + '/assetTurn/list',
  get: contextPath + '/assetTurn/get',
  btnHandle: contextPath + '/assetTurn/btnHandle',
};
export const assetLostPath = {
  flag: 'assetLostPath',
  List: AssetLoseList,
  fullLose: contextPath + '/assetLose/fullLose',
  haveLose: contextPath + '/assetLose/haveLose',
};
